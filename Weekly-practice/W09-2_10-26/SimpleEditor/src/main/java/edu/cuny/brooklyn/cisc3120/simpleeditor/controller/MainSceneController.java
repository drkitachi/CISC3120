...
public class MainSceneController {
    ...
    void aboutApp(ActionEvent event) {
    	String infoAbout = "This is a simple HTML editor with the function of " +
    						"opening an existing .html file and edit it or "+
    						"creating a new file and save it. The editor has "
    						+ "the simple functionalities of a word editor.";
    	Alert about = new Alert(AlertType.INFORMATION, infoAbout, ButtonType.CLOSE);
        about.setTitle("Simple Editor Help");
        about.setHeaderText("About Simple Editor");                
        about.showAndWait();
    }
