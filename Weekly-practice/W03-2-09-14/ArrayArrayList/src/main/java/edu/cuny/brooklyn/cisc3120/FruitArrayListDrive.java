...
public class FruitArrayListDrive {
	public static void main(String[] args) {
		 ...
		 *       Solution 1: Using the method equalsIgnoreCase() from the String
		 *       class, I can use a loop to find the index of the element in the 
		 *       list and then use the index to remove the element making the delete
