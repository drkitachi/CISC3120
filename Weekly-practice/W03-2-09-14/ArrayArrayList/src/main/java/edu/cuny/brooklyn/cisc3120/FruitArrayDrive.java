...
/*	The method of the String class I look up was 
	the equalsIgnoreCase() method in order to compare
	the banana with lower case
	URL: https://docs.oracle.com/javase/7/docs/api/java/lang/String.html#equalsIgnoreCase(java.lang.String)
*/
