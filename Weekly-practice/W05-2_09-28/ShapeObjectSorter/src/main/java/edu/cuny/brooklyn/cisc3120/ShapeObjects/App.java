...
public class App 
{
    public static void main(String[] args) {
    	...
    	//List of Shapes sort by length of names
        ...
        //make new List of Shapes and sort it by area
        ArrayList<Shape> shapeSecondList = makeRandomShapes(5);
        System.out.println("\nList of shapes before sorted on the area");
        for(Shape s: shapeSecondList) {
        	System.out.println(s.getName() + ": " + s.area());
        }
        shapeSecondList.sort(new ShapeAreaComparator());
        System.out.println("\nList of shapes after sorted on the area");
        for(Shape s: shapeSecondList) {
        	System.out.println(s.getName() + ": " + s.area());
        }
    }
